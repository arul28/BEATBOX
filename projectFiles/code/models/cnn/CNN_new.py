...
def main():
    ...
    np.save(os.path.join(output_dir, 'instrument_labels.npy'), labels)
    np.save(os.path.join(output_dir, 'participants.npy'), participants)
    
    # Also save the scaled embeddings
    np.save(os.path.join(output_dir, 'scaled_embeddings.npy'), scaled_embeddings)
    ...
    print(f"- scaled_embeddings.npy: {scaled_embeddings.shape}")
    print(f"- instrument_labels.npy: {labels.shape}")
    print(f"- participants.npy: {participants.shape}")
